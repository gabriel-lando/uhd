...
// band_splitter.cpp.
//
// All symbols live in uhd::usrp::bonded::detail and are marked inline so
...
namespace uhd { namespace usrp { namespace bonded { namespace detail {
...
}}}} // namespace uhd::usrp::bonded::detail
